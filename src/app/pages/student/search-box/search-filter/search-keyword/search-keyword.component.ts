...
export class SearchKeywordComponent extends BasePage implements OnInit {
  ...
  constructor(injector: Injector, private searchFilterService: SearchFilterService) {
    super(injector);
  }
  ...
  setKeyworkIn($event){
    console.log("setKeyworkIn", $event);
    this.searchFilterService.setKeywords($event.subs)
  }
