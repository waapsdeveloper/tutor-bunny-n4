...
import { bannerData, infoData, teacherCardInfo } from 'src/app/interfaces/detail-data';
import { GlobalStudyMaterialService } from 'src/app/services/global-study-material.service';

@Component({
  selector: 'app-teacher-material-detail',
  templateUrl: './teacher-material-detail.page.html',
  styleUrls: ['./teacher-material-detail.page.scss'],
})
export class TeacherMaterialDetailPage extends BasePage {
  [x: string]: any;
