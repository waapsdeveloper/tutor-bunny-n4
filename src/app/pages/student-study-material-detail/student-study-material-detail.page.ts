...
@Component({
  selector: 'app-student-study-material-detail',
  templateUrl: './student-study-material-detail.page.html',
  styleUrls: ['./student-study-material-detail.page.scss'],
})
export class StudentStudyMaterialDetailPage extends BasePage {
